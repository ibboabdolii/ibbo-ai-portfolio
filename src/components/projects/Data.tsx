...
const PROJECT_CONTENT = [
  {
    ...
    techStack: ['ABB IRC5', 'Säkerhetsgivare / sensorer', 'Mekanisk justering', 'Elinstallation', 'Felsökning'],
    date: '2025',
    links: [{ name: 'Internal Report (EA)', url: 'https://ibboabdoli.com' }],
    images: [
      { src: '/projects/scania-cw32-1.jpg', alt: 'Scania CW32 laser protection turntable' },
      { src: '/projects/scania-cw32-2.jpg', alt: 'Sensor relocation and flap installation' },
    ],
  },
  {
    ...
    techStack: ['PLC (Siemens / TIA Portal)', 'Vibrationssensorer', 'Signal- och I/O-felsökning', 'Produktionslinor'],
    date: '2025',
    links: [{ name: 'Summary', url: 'https://ibboabdoli.com' }],
    images: [{ src: '/projects/lantmannen-1.jpg', alt: 'Packaging line at Lantmännen' }],
  },
...
Läsa elscheman, mäta, hitta fel kabel, åtgärda kabeldragning och verifiera funktion genom testkörning.`,
    techStack: ['Elinstallation', 'Felsökning', 'Elscheman', 'Mätning / multimeter', 'Kablage'],
    date: '2025',
    links: [{ name: 'Summary', url: 'https://ibboabdoli.com' }],
    images: [{ src: '/projects/meritor-1.jpg', alt: 'Electrical panel troubleshooting at Meritor' }],
  },

  {
    title: 'Volvo – ABB Robot Motion Supervision',
    description:
      'Felsökning av SafeMove / motion supervision-larm på ABB-robot. Verifiering av axelövervakning, loggar, positioner och justering av gränser/offsets tillsammans med produktion.',
    techStack: ['ABB IRC5', 'SafeMove', 'RobotStudio', 'Felsökning', 'Produktion / drift'],
    date: '2025',
    links: [{ name: 'Summary', url: 'https://ibboabdoli.com' }],
    images: [{ src: '/projects/volvo-robot-1.jpg', alt: 'ABB robot troubleshooting at Volvo' }],
  },
];
    ...
    <div className="space-y-10">
      <div className="rounded-3xl bg-[#F5F5F7] p-8 dark:bg-[#1D1D1F]">
        <div className="space-y-6">
          ...
          <p className="text-secondary-foreground font-sans text-base leading-relaxed md:text-lg whitespace-pre-line">
